...
Designed by Google specifically for multi-horizon forecasting with interpretability.
...
- Support for known future inputs and static covariates
...
def predict_tft(train_series: pd.Series, horizon: int,
