...
def _write_markdown_report(
    ...
    *,
    ...
    lines = [
        ...
        "",
        "Experiment split: train = series[0 : n − H_max], test = series[n − H_max : n],",
        "where H_max is the longest horizon for that series. Shorter horizons are prefixes",
        "of the long test window and share the same forecast origin.",
        "",
